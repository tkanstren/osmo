 ...
 *
 * @see osmo.tester.generator.testlog.TestLog
 *
 * @author Teemu Kanstren
 */
//TODO: add tests for someone having set the testlog object to non-null value+wrong data type
//TODO: check what constraints can be set on an annotation (only on field, only of specific type..)
@Retention(RetentionPolicy.RUNTIME)
public @interface TestLogField {
}
